...
class DetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        token = NotificationCenter.default.addObserver(forName: ComposeViewController.MomoDidChange, object: nil, queue: OperationQueue.main, using: { [weak self] (noti) in self?.memoTableView.reloadData()
